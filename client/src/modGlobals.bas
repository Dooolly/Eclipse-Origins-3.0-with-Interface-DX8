...
' Hotbar
Public Hotbar(1 To MAX_HOTBAR, 1 To MAX_HOTBAR_NUM) As HotbarRec
Public ActualHotbar As Byte

' Amount of blood decals
Public BloodCount As Long

' Exp máxima do jogador
Public PlayerXP As Long

' Mensagem privada
Public MsgPrivate As String
...
Public PlayerSpells(1 To MAX_PLAYER_SPELLS) As PlayerSpellRec ' Lista de jutsus
