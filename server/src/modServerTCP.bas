...
Sub SendWornEquipment(ByVal Index As Long)
    ...
    Buffer.WriteInteger GetPlayerEquipment(Index, Armor)
    Buffer.WriteInteger GetPlayerEquipment(Index, Weapon)
    Buffer.WriteInteger GetPlayerEquipment(Index, Helmet)
    Buffer.WriteInteger GetPlayerEquipment(Index, Shield)
    SendDataTo Index, Buffer.ToArray()
...
Sub SendMapEquipmentTo(ByVal PlayerNum As Long, ByVal Index As Long)
    ...
    Buffer.WriteInteger GetPlayerEquipment(PlayerNum, Armor)
    Buffer.WriteInteger GetPlayerEquipment(PlayerNum, Weapon)
    Buffer.WriteInteger GetPlayerEquipment(PlayerNum, Helmet)
    Buffer.WriteInteger GetPlayerEquipment(PlayerNum, Shield)
...
Sub SendBlood(ByVal mapNum As Byte, ByVal X As Long, ByVal Y As Long)
    Dim Buffer As clsBuffer
...
Sub SendAnimation(ByVal mapNum As Byte, ByVal Anim As Integer, ByVal X As Integer, ByVal Y As Integer, Optional ByVal LockType As Byte = 0, Optional ByVal LockIndex As Integer = 0, Optional ByVal OnlyTo As Integer = 0)
    Dim Buffer As clsBuffer
...
Sub SendChatBubble(ByVal mapNum As Long, ByVal target As Integer, ByVal targetType As Byte, ByVal message As String, ByVal Colour As Long)
Dim Buffer As clsBuffer
